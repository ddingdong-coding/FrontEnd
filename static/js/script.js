$(function () {
    // 검색창 클릭시 최근검색어창 토글
    // ico_arr 이미지 변경
    console.log("클릭 토글", recentSearchData) //성공
    $(".input_text").click(function () {
        // 검색기록창 토글
        console.log("클릭22,", recentSearchData.length)
    ...
    $("#sform").on("submit", function (e) {
        ...
        console.log("4", recentSearchItem)
        //확인 완료!
        // recentSearchData 배열에 앞에서 부터 recentSearchItem 삽입
        const recentSearch = recentSearchItem;
        console.log("5", recentSearch)
        //확인 완료!
        console.log("5.5", recentSearchData)
        recentSearchData.unshift(recentSearch);
        console.log("6", recentSearchData.length)
